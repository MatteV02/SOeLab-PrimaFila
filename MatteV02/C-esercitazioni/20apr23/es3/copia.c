#include <stdio.h> // includo questa libreria per avere il comando printf
#include <stdlib.h>	// includo questa libreria per avere la funzione exit
#include <unistd.h> // includo questa libreria per avere la macro BUFSIZ
#include <fcntl.h>	// includo questa libreria per implementare il supporto su file
